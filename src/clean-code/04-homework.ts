(() => {
  ...
  // Agrego un tipo para colocar los colores permitidos muy parecido a una interface o una clase
  type FruitColor = 'red'|'yellow'|'purple';
  function getFruitsByColor( color: FruitColor ): string[] {

    // Creo un objeto literal muy parecido a un switch
    const fruitsByColor = {
      red:      ['manzana','fresa'],
      yellow:   ['piña','banana'],
      purple:   ['moras','uvas'],
    };
    // Si La la llave que tenga ese objeto fruitsByColor no incluye color manda el throw
