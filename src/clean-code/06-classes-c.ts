(()=>{
  ...
  // Aplicando Principio Responsabilidad Unica 
...
//  Forma corta de crear una clase y se aplica el Principio de Responsabilidad Unica
class Person {
    public name     : string;
...
// Creo una nueva clase que va a ser una Composición
// Priorizar la composicion frente a la herencia!
